...
def main():
    ...
    parser.add_argument("--indices_path", type=str, required=True, help="Path to the pre-calculated indices.json file.")
    parser.add_argument("--save_path", type=str, default="./compressed_distilled_model", help="Directory to save the distilled small attention weights.")
    ...
    print(f"Saving distilled small attention weights to {args.save_path}...")
    ...
    small_path = os.path.join(args.save_path, "small_attn_weights.pt")
